      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <Card 
              key={index} 
              className="group hover:shadow-lg transition-all duration-300 border-vilo-purple-100 dark:border-vilo-purple-700 hover:border-vilo-purple-300 dark:hover:border-vilo-purple-500 hover:-translate-y-1 dark:bg-gray-800"
            >
              <CardHeader className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-vilo-purple-100 to-vilo-pink-100 dark:from-vilo-purple-800/50 dark:to-vilo-pink-800/50 rounded-2xl flex items-center justify-center group-hover:from-vilo-purple-500 group-hover:to-vilo-pink-500 transition-all duration-300">
                  <service.icon className="w-8 h-8 text-vilo-purple-600 dark:text-vilo-purple-400 group-hover:text-white transition-colors duration-300" />
                </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-vilo-purple-50 to-vilo-pink-50 dark:from-vilo-purple-900/30 dark:to-vilo-pink-900/30 rounded-2xl p-8 max-w-4xl mx-auto">
